{
  ...
  outputs = all@{ self, c-hello, rust-web-server, nixpkgs, nix-bundle, ... }: {
    ...
    # Necessary for using Flakes on the NixOS System.
    nix.settings.experimental-features = "nix-command flakes";

    # I defaultly set an empty zsh dotfile here. Copy it to /etc/zshrc
    programs.zsh.enable = true;

    # Other options and flakes programs visit github:nix-community/flakes
    # This is a minimal, basic configuration of flakes.
  };
}
